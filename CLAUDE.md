...
- `src/z3rno_server/api/` — Route handlers: memories.py (store/recall/forget), audit.py, sessions.py, health.py
...
- `src/z3rno_server/workers/` — Celery tasks: lifecycle.py, embeddings.py, celery_app.py
...
- Public paths skip auth: /v1/health, /v1/ready, /docs, /redoc, /openapi.json
